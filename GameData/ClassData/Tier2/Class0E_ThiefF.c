...
extern const s8 ThiefFAnims[];

const struct ClassData Class0E_ThiefF = {
	
	// Journeyman
	.nameTextId = 0x2C5,
	.descTextId = 0x311,
	.number = 0x0E,
	.promotion = CLASS_ASSASSIN_F,
	.SMSId = 0x08,
	.slowWalking = 0,
	...
	.attributes = CA_FEMALE + CA_STEAL + CA_THIEF,
